...
while i < len(raw_lines):
    ...
    if line.startswith("#EXTINF"):
        ...
        if i < len(raw_lines):
            ...
            # যদি মুভি না হয় এবং লিঙ্কটি ইউনিক হয়
            if not is_movie_ext and not is_movie_keyword and not is_long_duration:
...
with open("BDIX-Playlist.m3u", "w", encoding="utf-8") as f:
    ...
    f.write(f"# 📺 Channels Count: {total_channels}\n")
...
print("Successfully generated playlist with", total_channels, "channels!")
